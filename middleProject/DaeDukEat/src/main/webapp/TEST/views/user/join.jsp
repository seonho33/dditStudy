...
<body>
    ...
    <header class="bg-white border-b py-5 shadow-sm mb-8">
        <div class="max-w-[1200px] mx-auto px-5">
            <a href="${pageContext.request.contextPath}/list.do" class="text-4xl b-grade-font text-orange-500">D.D.M</a>
        </div>
    </header>
    ...
    <main class="max-container">
        <div class="bg-white rounded-[50px] shadow-2xl p-12 border-2 border-gray-100">
            ...
            <form id="joinForm" action="${pageContext.request.contextPath}/insert.do" method="post" class="space-y-7">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-3">
                        <input type="text" name="userId" id="userId" class="input-base" 
                    ...
                    <c:if test="${not empty idMsg}">
                        <p class="text-xs ml-5 font-bold ${idcheck ? 'text-green-500' : 'text-red-500'}">${idMsg}</p>
                    </c:if>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="space-y-2">
                        ...
                        <input type="password" name="password" id="userPw" class="input-base" placeholder="비밀번호 입력" required>
                    </div>
                    <div class="space-y-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" class="input-base" placeholder="실명 입력" required>
                    </div>
                    <div class="space-y-2">
                        <label class="block text-sm font-black text-gray-500 ml-5 uppercase">Birth</label>
                        <input type="date" name="bir" class="input-base text-gray-400" required>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="hidden" name="mail" id="fullEmail">
                </div>

                <div class="space-y-2">
                    <label class="block text-sm font-black text-gray-500 ml-5 uppercase">Class Number</label>
                    <input type="number" name="userNum" class="input-base" min="1" placeholder="클래스 번호 입력" required>
                    <p class="text-xs ml-5 text-gray-400">※ 숫자만 입력 가능합니다</p>
                </div>
                ...
                <div class="flex gap-4 pt-8">
                    ...
                    <button type="button" onclick="location.href='${pageContext.request.contextPath}/main.do'" class="flex-1 py-4 rounded-full text-xl b-grade-font text-gray-400 bg-gray-100 hover:bg-gray-200 transition-all text-center">
                        취소
                    </button>
                </div>
            </form>
    ...
    <script>
        ...
        function checkIdSubmit() {
            ...
            // ⭐ contextPath를 포함한 절대경로 사용
            location.href = contextPath + "/checkId.do?userId=" + encodeURIComponent(userId);
        }
