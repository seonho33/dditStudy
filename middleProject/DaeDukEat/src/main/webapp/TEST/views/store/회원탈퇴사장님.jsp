...
<div class="max-w-2xl mx-auto text-center animate-fadeIn">
    ...
    <form action="deleteOwner.do" method="post" class="flex gap-4 max-w-sm mx-auto">
        <input type="hidden" name="mem_id" value="${loginUser.userId}">

        <button
            type="button"
            onclick="loadOwnerPage('store','가게관리.jsp', document.querySelector('.nav-link.active'))"
