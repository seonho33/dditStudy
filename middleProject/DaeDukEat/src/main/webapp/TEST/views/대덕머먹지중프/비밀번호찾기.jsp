...
<head>
    ...
    <style>
        ...
        .btn-orange:disabled { background-color: #fed7aa; cursor: wait; }
    ...
    <div class="w-full max-w-[480px]">
        ...
        <div class="bg-white p-10 rounded-[40px] shadow-xl border border-gray-100">
            ...
            <div id="reset-section" class="animate-down">
                ...
                <button onclick="resetPW()" class="w-full py-4 btn-orange text-lg shadow-lg">비밀번호 변경 완료</button>
            </div>
            ...
            <div id="success-section" class="text-center py-4 animate-down">
                <div class="bg-orange-50 rounded-[30px] p-8 mb-6 border-2 border-dashed border-orange-200">
                    ...
                    <p class="text-orange-900 font-black text-xl mb-2">변경 성공!</p>
                    <p class="text-gray-500 font-bold text-sm">새로운 비밀번호로 로그인하세요.</p>
                </div>
                <button class="w-full py-4 btn-orange text-lg" onclick="location.reload()">로그인 하러가기</button>
            </div>
        </div>
    </div>
