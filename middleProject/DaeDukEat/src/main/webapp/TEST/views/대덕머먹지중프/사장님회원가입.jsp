...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
		...
		.btn { padding: 14px 16px; border: none; border-radius: 8px; font-size: 15px; font-weight: 600; cursor: pointer; transition: all 0.2s; text-align: center; }
    ...
    <div class="container">
        ...
        <div class="progress-container">
            <div class="progress-steps">
		     ...
		     <div class="content">
		    <form id="storeForm" method="post" action="${pageContext.request.contextPath}/registerStore" enctype="multipart/form-data">
                  ...
                  <div class="step-content" data-step="3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-upload" onclick="document.getElementById('fileInput').click()">
						    ...
						    <div id="previewContainer"></div> <!-- 미리보기 영역 추가 -->
						</div>
					</div> 
                </div>
