...
.product-link {
    ...
    display: block;          /* 카드 전체 클릭 가능 */
}

.product-link:visited {
    color: inherit;          /* 방문 후에도 색 안 변함 */
}
...
<body>
    ...
    <div class="hero-banner">
        <div class="banner-content">
            ...
            <p class="banner-period">1.29(목) ~ 2.19(목)</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="top3-section">
            ...
            <div class="top3-grid">
                <!-- 꽃다발 -->
                <div class="top3-card">
                    <img class="top3-image" src="${pageContext.request.contextPath}/images/upload/store/와인.jpg" alt="ㅁ">
      ...
      <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE110"
         class="product-link">
        <div class="product-card">
          <img class="product-image" src="${pageContext.request.contextPath}/images/upload/store/보보스.jpg" alt="프리미엄 장미 꽃다발">
          <div class="product-content">
            <span class="product-badge">베스트</span>
            <h3 class="product-name">BOBOS</h3>
...
<a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE111"
         class="product-link">
            <div class="product-card">
            ...
            <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE112"
         class="product-link">
            <div class="product-card">
                <img class="product-image" src="${pageContext.request.contextPath}/images/upload/store/엠피플.jpg" alt="해바라기 꽃바구니">
                <div class="product-content">
                  
                    <h3 class="product-name">엠피플</h3>
                    <div class="product-price">
         ...
         <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE113"
            class="product-link">
            <div class="product-card">
        ...
        <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE078"
         class="product-link">
            <div class="product-card">
           ...
           <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE115"
         class="product-link">
            <div class="product-card">
           ...
           <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE116"
         class="product-link">
            <div class="product-card">
           ...
           <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE117"
         class="product-link">
            <div class="product-card">
        ...
        <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE077"
         class="product-link">
            <div class="product-card">
         ...
         <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE076"
         class="product-link">
            <div class="product-card">
           ...
           <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE103"
         class="product-link">
            <div class="product-card">
           ...
           <a href="${pageContext.request.contextPath}/storeDetail.do?id=STORE075"
         class="product-link">
            <div class="product-card">
        ...
        <div class="event-banner">
            ...
            <a href="#" class="event-button">패키지 상품 보러가기 →</a>
        </div>
    </div>
            ...
            button.addEventListener('click', function() {
                ...
                productGrids.forEach(grid => {
                    ...
                    if (selectedCategory === 'all') {
                        ...
                        // 특정 카테고리: 해당 카테고리만 표시
                        if (gridCategory === selectedCategory) {
                            grid.style.display = 'grid';
                        } else {
