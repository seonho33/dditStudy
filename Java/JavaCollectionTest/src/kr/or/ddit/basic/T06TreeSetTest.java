...
public class T06TreeSetTest {
	public static void main(String[] args) {
		...
		/* TreeSet에 저장된 자료 중 특정한 작은 자료를 찾아서
		 * SortedSet으로 반환하는 메소드가 있다.
		 * => headSet(기준값) : 기본적으로 '기준값' 포함안됨.
		 * => headSet(기준값, 논리값) : 논리값이 true면 기준값 포함됨
		 */
		SortedSet<String> ss1 = ts.headSet("K");
		System.out.println("K 이전 자료 : " + ss1);
		System.out.println("K 이전 자료 (기준값도 포함) : " + ts.headSet("K",true));
		
		/*
		 * 기준값보다 큰 자료를 찾아 SortedSet으로 반환하는 메서드
		 * => tailSet ( 기준값) : 기본적으로 '기준값' 포함
		 * => tailSet (기준값, 논리값) : 논리값이 false면 기준값 미포함
		 */
		...
		/*
			subSet(기준값1, 기준값2) : 기준값1~ 기준값2 사이 값
								   '기준값' 포함, '기준값2'미포함
			seubSet(기준값1, 논리값1, 기준값2, 논리값2)
				   각 기준값을 포함할지 여부를 논리값으로 설정한다
		*/
