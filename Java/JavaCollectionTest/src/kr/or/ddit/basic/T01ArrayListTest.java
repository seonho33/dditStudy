...
public class T01ArrayListTest {
	public static void main(String[] args) {
		...
		//add():데이터 끼워넣기
		list1.add(0,"zzz");
		System.out.println("list1(끼워넣기한후) =>"+list1);
		
		//set():데이터 변경하기 : set()메서드 이용
		...
		//contains(비교객체) => 리스트에 '비교객체'가 있으면 true 없으면 false 가 반환됨.
		
		System.out.println(list2.contains("DDD"));
		System.out.println(list2.contains("ZZZ"));
		
		//indexOf(비교객체) => 리스트에 '비교객체'를 찾아서 해당 인덱스 값을 반환한다. 없으면 -1을 반환
		System.out.println("DDD의 인덱스 값:"+ list2.indexOf("DDD"));
		System.out.println("ZZZ의 indexOf 값: " + list2.indexOf("ZZZ"));
		//////////
