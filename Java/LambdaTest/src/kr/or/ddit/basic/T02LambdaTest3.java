	...
	public static void main(String[] args) {
		...
		LambdaTestInterface1 lam1 = new LambdaTestInterface1() {
			...
			public void test() {
				...
				System.out.println("익명 구현객체 방식입니다");
			}
		};
		lam1.test();
...
/*
 	...
 	4) 매개변수가 하나도 없으면 괄호 '()'를 생략랄 수 없다.
 	예) () -> System.out.println("안녕")
 	
 	5) 반환값이 있을 경우에는 return 문을 사용한다.
 	예) (a,b) -> {return a+b;}
 	   (a,b) -> return a+B
 
	6) 실행문에 return 문만 있을 경우 return 과 '{}'를 생략할 수 있다.
	예) (a,b) -> a + b
 */
