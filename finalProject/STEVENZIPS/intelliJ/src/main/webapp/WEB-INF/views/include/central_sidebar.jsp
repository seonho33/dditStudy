...
<aside class="min-h-screen w-64 fixed left-0 top-0 bg-white border-r border-gray-200 flex flex-col z-40 overflow-y-auto">
  ...
  <nav class="flex flex-col gap-1 px-3 mt-6 pb-10" id="sidebar-nav">
    ...
    <details class="nav-item group">
      <summary class="flex items-center justify-between px-3 py-3 rounded-full cursor-pointer hover:bg-white/50 transition-colors">
        <div class="flex items-center gap-2">
          <span class="material-symbols-outlined text-[#226046] text-xl">info</span>
      ...
      <div class="flex flex-col gap-1 mt-1 ml-8 pr-2 mb-2">
        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/main/intro.do">서비스 소개</a>
      </div>
    </details>
    ...
    <details class="nav-item group">
      <summary class="flex items-center justify-between px-3 py-3 rounded-full cursor-pointer hover:bg-white/50 transition-colors">
        <div class="flex items-center gap-2">
          <span class="material-symbols-outlined text-[#226046] text-xl">description</span>
      ...
      <div class="flex flex-col gap-1 mt-1 ml-8 pr-2 mb-2">
        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/contract/notice.do">계약 공고</a>
        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/contract/history.do">청약 조회</a>
      </div>
    </details>
    ...
    <details class="nav-item group">
      <summary class="flex items-center justify-between px-3 py-3 rounded-full cursor-pointer hover:bg-white/50 transition-colors">
        <div class="flex items-center gap-2">
          ...
          <span class="font-bold text-sm text-gray-700 whitespace-nowrap">매물 정보</span>
        </div>
        <span class="material-symbols-outlined text-sm transition-transform group-open:rotate-180">expand_more</span>
      </summary>
      <div class="flex flex-col gap-1 mt-1 ml-8 pr-2 mb-2">
        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/rent/map">매물 지도</a>
      </div>
      <div class="flex flex-col gap-1 mt-1 ml-8 pr-2 mb-2">
        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/rent/list">매물 목록</a>
      </div>
    </details>
    ...
    <details class="nav-item group">
      <summary class="flex items-center justify-between px-3 py-3 rounded-full cursor-pointer hover:bg-white/50 transition-colors">
        <div class="flex items-center gap-2">
          <span class="material-symbols-outlined text-[#226046] text-xl">domain</span>
      ...
      <div class="flex flex-col gap-1 mt-1 ml-8 pr-2 mb-2">
        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/main/apt/list.do">단지 목록</a>

        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/main/apt/search.do">단지 검색</a>

        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/main/apt/map.do">지도 검색</a>

        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/facility/history.do">단지 시설정보</a>

        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/main/apt/dashboard.do">단지별 통계 조회</a>
      </div>
    </details>
    ...
    <details class="nav-item group">
      ...
      <div class="flex flex-col gap-1 mt-1 ml-8 pr-2 mb-2">
        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/board/notice/list.do">공지사항</a>
        <a class="px-3 py-2 text-sm text-gray-600 hover:text-[#226046] hover:bg-white/70 rounded-full transition-all whitespace-nowrap"
           href="${pageContext.request.contextPath}/apt/board/inqry/list.do">문의게시판</a>
      </div>
    </details>
  </nav>
...
<script>
  ...
  /*
   * 현재 접속한 URL과 사이드바 메뉴 href를 비교해서
   * 같은 메뉴에 sidebar-active 클래스를 자동으로 붙인다.
   */
...
<%--
<jsp:include page="../include/websocket.jsp"/>--%>
