    ...
    <main class="content-area">
      <div class="page-content-wrap">
        <div class="breadcrumb">
          ...
          <span>›</span>
          <span class="cur">즐겨찾기</span>
        </div>
        <h1 class="page-title">즐겨찾기</h1>
        <p class="page-desc">PPT에 직접 명시되진 않았지만 현재 메뉴에 존재하는 경로용 화면입니다. 자주 사용하는 메뉴를 빠르게 모아두는 용도로 사용할 수 있습니다.</p>

        <section class="menu-grid"><div class="menu-card"><h4>관리비조회</h4><p>이번 달 청구 금액과 세부 항목을 바로 확인합니다.</p><div class="menu-links"><a href="${pageContext.request.contextPath}/fee/inquiry">바로가기</a></div></div><div class="menu-card"><h4>민원신청</h4><p>시설, 소음, 주차, 청소, 기타 민원을 즉시 등록합니다.</p><div class="menu-links"><a href="${pageContext.request.contextPath}/complaint/apply">바로가기</a></div></div><div class="menu-card"><h4>시설예약</h4><p>독서실, 테니스장, 회의실 예약 화면으로 이동합니다.</p><div class="menu-links"><a href="${pageContext.request.contextPath}/service/facility">바로가기</a></div></div></section>
