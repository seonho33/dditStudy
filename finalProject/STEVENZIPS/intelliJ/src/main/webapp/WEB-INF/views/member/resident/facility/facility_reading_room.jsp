    ...
    <main class="content-area">
      <div class="page-content-wrap">
        <div class="breadcrumb">
          ...
          <span>›</span>
          <span class="cur">편의시설예약 : 독서실</span>
        </div>
        <h1 class="page-title">편의시설예약 : 독서실</h1>
        <p class="page-desc">좌석배치도를 확인하고 좌석 선택, 예약 날짜 선택, 예약하기 버튼을 구성한 독서실 예약 화면입니다.</p>
...
<section class="grid-2">
  <div class="panel">
    ...
    <div class="seat-grid">
      <div class="seat available">A-01</div>
      <div class="seat available">A-02</div>
      <div class="seat busy">A-03</div>
      <div class="seat available">A-04</div>
      <div class="seat selected">A-05</div>
      <div class="seat busy">A-06</div>
      <div class="seat available">B-01</div>
      <div class="seat busy">B-02</div>
      <div class="seat available">B-03</div>
      <div class="seat available">B-04</div>
      <div class="seat available">B-05</div>
      <div class="seat busy">B-06</div>
  ...
  <div class="form-grid">
    <div class="th">선택 좌석</div>
    <div class="td">A-05</div>
    <div class="th">예약 날짜</div>
    <div class="td">
      <input class="fake-input" value="2026-04-28" />
    </div>
    <div class="th">이용 시간</div>
    <div class="td">
    ...
    <div class="th">이용자</div><div class="td">홍길동 / 101동 1203호</div></div><div class="btn-row"><button class="btn-main">예약하기</button></div></div></section>
