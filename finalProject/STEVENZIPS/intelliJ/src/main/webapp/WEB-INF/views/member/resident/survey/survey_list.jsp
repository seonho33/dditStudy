...
<body>
  ...
  <div class="main-shell">
    ...
    <main class="content-area">
      <div class="page-content-wrap">
        ...
        <h1 class="page-title">투표 및 설문조사</h1>
        <p class="page-desc">카테고리와 키워드 검색, 목록 조회, 진행상태를 포함한 투표,설문조사 목록 화면입니다.</p>
                ...
                <td>
                  ...
                  <c:choose>
                    ...
                    <c:when test="${survey.surveySttsCd eq 'OPEN'}">
                      ...
                      <a href="${pageContext.request.contextPath}/resident/survey/detail/${aptCmplexNo}/${survey.surveyNo}"
                         style="
            font-weight:700;
            color:var(--text-dark);
  ...
  ">
                    ...
                    <c:choose>
                      ...
                      <c:when test="${survey.surveyTypeCd eq 'SURVEY'}">
                        설문
                      </c:when>
