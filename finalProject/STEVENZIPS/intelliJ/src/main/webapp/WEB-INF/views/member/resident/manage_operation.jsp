    ...
    <main class="content-area">
      <div class="page-content-wrap">
        <div class="breadcrumb">
          ...
          <span>›</span>
          <span class="cur">운영정보공개</span>
        </div>
        <h1 class="page-title">운영정보공개</h1>
        <p class="page-desc">운영 공지, 연락처, 최근 안내 자료를 한 화면에 정리한 운영정보 공개 화면입니다.</p>

        <section class="stats-grid"><div class="stat-card"><div class="stat-label">이번 달 공지</div><div class="stat-value">12건</div><div class="stat-sub">중요 공지 3건 포함</div></div><div class="stat-card"><div class="stat-label">민원 평균 처리</div><div class="stat-value">1.8일</div><div class="stat-sub">지난달 대비 0.4일 단축</div></div><div class="stat-card"><div class="stat-label">시설 점검 완료</div><div class="stat-value">94%</div><div class="stat-sub">정기 점검 기준</div></div><div class="stat-card"><div class="stat-label">입주민 만족도</div><div class="stat-value">4.6점</div><div class="stat-sub">5점 만점 기준</div></div></section>
        <section class="grid-2"><div class="card"><div class="section-hd"><h3>운영 안내</h3><span>기준 정보</span></div><div class="label-grid"><div class="th">운영시간</div><div>평일 09:00 ~ 18:00 / 점심 12:00 ~ 13:00</div><div class="th">대표번호</div><div>042-000-0000</div><div class="th">긴급 연락</div><div>야간 당직 042-000-0001</div><div class="th">이메일</div><div>info@daedeokapt.co.kr</div></div></div><div class="card"><div class="section-hd"><h3>이번 주 안내</h3><span>입주민 공지</span></div><ul class="bullet-list"><li>4월 28일 오전 10시 지하주차장 정기 소독 예정</li><li>분리수거장 환경개선 공사로 일부 동선이 변경됩니다.</li><li>어린이놀이터 보수 점검이 4월 넷째 주에 진행됩니다.</li><li>엘리베이터 비상통화 장치 점검 완료 안내</li></ul></div></section>
        <section class="panel"><div class="section-hd"><h3>최근 공개 자료</h3><span>월간 공개 문서</span></div><table class="data-table"><thead><tr><th>구분</th><th>제목</th><th>등록일</th><th>첨부</th></tr></thead><tbody><tr><td>운영보고</td><td>2026년 4월 관리사무소 운영 현황</td><td>2026-04-10</td><td><span class="badge info">PDF</span></td></tr><tr><td>회계안내</td><td>공동관리비 사용 내역 공개</td><td>2026-04-09</td><td><span class="badge info">XLS</span></td></tr><tr><td>시설공지</td><td>승강기 정기점검 결과 안내</td><td>2026-04-07</td><td><span class="badge info">PDF</span></td></tr></tbody></table></section>
