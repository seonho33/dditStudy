  ...
  <div class="main-shell">
    ...
    <main class="content-area">
      <div class="page-content-wrap">
        ...
        <p class="page-desc">메뉴 진입용 화면입니다. 목록, 글쓰기, 상세보기 화면으로 이동할 수 있습니다.</p>

        <section class="menu-grid">
          <div class="menu-card">
            <h4>자유게시판 목록</h4>
            <p>게시글 검색 및 필터, 페이징이 포함된 목록 화면입니다.</p>
            <div class="menu-links">
              <a href="${pageContext.request.contextPath}/resident/board/free/list/${aptCmplexNo}">목록</a>
            </div>
          </div>
          <div class="menu-card">
            <h4>글쓰기</h4>
            <p>제목, 내용, 파일첨부를 입력하는 작성 화면입니다.</p>
            <div class="menu-links">
              <a href="${pageContext.request.contextPath}/resident/board/free/write/${aptCmplexNo}">글쓰기</a>
            </div>
          </div>
