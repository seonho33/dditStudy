			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">${freeVO.freeTitle}</h3>
						<div class="card-tools mt-1">
						${freeVO.freeWriter }${freeVO.freeDate }${freeVO.freeHit }
						</div>
					</div>
					<div class="card-body">
					...
					<div class="card-footer">
						...
						<form action="" method="get" id="freeNoForm">
...
$(function(){
	...
	modifyBtn.on("click",function(){
		location.href="/free/update.do?freeNo=${freeVO.freeNo}";
	});
	
	deleteBtn.on("click",function(){
		if(confirm("정말로 삭제하시겠습니까?")){
			freeNoForm.attr("action","/free/delete.do");
			freeNoForm.attr("method","post");
			freeNoForm.submit();
		}
	})
