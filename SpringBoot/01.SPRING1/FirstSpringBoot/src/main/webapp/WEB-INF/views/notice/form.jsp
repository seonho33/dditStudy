	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<form method="post" action="/notice/InsertForm.do" id="noticeForm" class="form-horizontal">
							<c:if test="${update eq 'update' }">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input id="noticeTitle" name="noticeTitle" type="text" class="form-control" value="${noticeVO.noticeTitle }" placeholder="제목을 입력해주세요.">
								</div>
							</div>
							<div class="form-group row mt-4">
								<label class="col-sm-2 control-label" >내용</label>
								<div class="col-sm-10">
									<textarea id="noticeContent" name="noticeContent" cols="50" rows="5" class="form-control" placeholder="content">${noticeVO.noticeContent }</textarea>
								</div>
							</div>
							<div class="form-group row mt-4">
								<div class="col-sm-offset-2 col-sm-12 ">
									<input type="button" value="${name }" class="btn btn-primary float-right" id="insertBtn">
									<c:if test="${update eq 'update' }">
										<input type="button" value="취소" class="btn btn-danger float-right" id="cancelBtn">
									</c:if>
									<c:if test="${update ne 'update' }">
...
$(function(){
	...
	cancelBtn.on("click",function(){
		location.href ="/notice/detail.do?noticeNo=${noticeVO.noticeNo}";
	});
