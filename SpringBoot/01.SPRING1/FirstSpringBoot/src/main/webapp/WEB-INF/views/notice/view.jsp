			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">${noticeVO.noticeTitle }</h3>
						<div class="card-tools mt-1">
							${noticeVO.noticeWriter }${noticeVO.noticeDate }${noticeVO.noticeHit }
						</div>
					</div>
					<div class="card-body">
					...
					<div class="card-footer">
						...
						<form action="" method="get" id="noticeNoForm">
...
$(function(){
	...
	modifyBtn.on("click",function(){
		noticeNoForm.attr("action","/notice/update.do");
		noticeNoForm.submit();
	});
	
	deleteBtn.on("click",function(){
		if(confirm("삭제하시겠습니까?")){
			noticeNoForm.attr("action","/notice/delete.do");
			noticeNoForm.attr("method","post");
			noticeNoForm.submit();
		}
	});
