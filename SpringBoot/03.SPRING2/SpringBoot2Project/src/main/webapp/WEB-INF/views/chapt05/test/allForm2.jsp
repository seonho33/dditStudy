      ...
      <div class="row">
        ...
        <div class="col-md-8 pt-5 pb-5">
          <div class="card">
            ...
            <div class="card-body">
              <form action="/ch/test/result2" id="allForm" method="post">
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="gender" id="genderM" checked="checked"  value="male" />
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="checkbox" id="developer" value="Y" name="developer"/>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="checkbox" id="foreigner" value="true" name="foreigner" />
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="carArray" multiple="multiple">
                      <option value="" selected>--선택--</option>
                ...
                <div class="mb-3 row">
                  <label for="hobbyList" class="col-sm-2 col-form-label">취미</label>
                  <div class="col-sm-10">
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="checkbox" id="hobbyChk1" value="sports" name="hobbyList" />
                      <label class="form-check-label" for="hobbyChk1">운동</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="checkbox" id="hobbyChk2" value="music" name="hobbyList"/>
                      <label class="form-check-label" for="hobbyChk2">음악감상</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="checkbox" id="hobbyChk2" value="movie" name="hobbyList"/>
                      <label class="form-check-label" for="hobbyChk2">영화감상</label>
                    </div>
                  </div>
                </div>
                <div class="mb-3 row">
            ...
            <div class="card-footer">
              <button type="button" class="btn btn-sm btn-primary" id="submitBtn">등록</button>
            </div>
          </div>
        </div>
        <div class="col-md-2"></div>
