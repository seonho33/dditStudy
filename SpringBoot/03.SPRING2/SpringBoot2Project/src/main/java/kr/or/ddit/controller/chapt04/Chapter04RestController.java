...
//@RestController 어노테이션은 @Controller와 @ResponseBody 어노테이션 두개의 조합으로 구성되어있습니다.
// 그렇기 때문에 메서드가 응답으로 내보내고있는 문자열, 객체, 바이너리 등등은 페이지의 위치 경로가 아닌 데이터임을
// 알수 있습니다.
@RestController
...
public class Chapter04RestController {
	...
	*/
	@GetMapping("/goRestHome0301")
	public Member goHome0301() {
		log.info("goRestHome0301()실행...!");
		return new Member();
		
	}
	@GetMapping("/goHome1111")
	public String goHome111() {
		return "";
	}
	...
	*/
	...
	@GetMapping("/goRestHome1102")
	public ResponseEntity<byte[]> goHome1102(){
		
		log.info("goRestHome1102() 실행함...!");
		InputStream in = null;
		ResponseEntity<byte[]> entity = null;
